function AppsTable({ rows, clustersByApp, l4IpsByApp, egressIpsByApp, selectedApps, onToggleRow, onSelectAll, onDeleteApp, onViewDetails, onCreateApp, showCreate, onOpenCreate, onCloseCreate }) {
